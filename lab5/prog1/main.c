...
// Funkcja wypisuje w osobnych liniach ³añcuchy wskazane przez n poczatkowych elementów tablicy indices.
...
// Funkcja wypisuje w osobnych liniach n ³añcuchów wskazywanych przez elementy tablicy ptab.
